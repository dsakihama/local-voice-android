...
- [~] **Faithfulness re-test** — E2B-CPU confirmed cleaning Text fillers without fabrication. **Notes markdown (the original 1B failure mode) still to verify** before final sign-off.
